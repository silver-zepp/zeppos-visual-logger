...
// AppSide & AppSettings requirement
import { BasePage } from "@zeppos/zml/base-page";

// Visual Logger
// import VisLog, { getDeviceInfoPlus } from "../libs/vis-log/vis-log";
...
// code to keep the display on
import { pauseDropWristScreenOff, pausePalmScreenOff, setWakeUpRelaunch } from "@zos/display";
...
Page(
  BasePage({
    onInit() {
      vis.updateSettings({ background_color: 0x000, timeout_enabled: false, line_count: 10 });
